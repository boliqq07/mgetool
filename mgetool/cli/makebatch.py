...
class CLICommand:
    ...
    def add_arguments(parser):
        ...
        parser.add_argument('-o', '--out_name', help='out file name', type=bool, default="batch.sh")

    @staticmethod
    def run(args, parser):
        make_batch_from_file(args.path_file, args.command,args.out_name)
...
if __name__ == '__main__':
    ...
    if args.paths is None:
        ...
        make_batch_from_file(args.paths, args.command,args.out_name)